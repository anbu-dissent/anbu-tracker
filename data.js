...
window.PLAN_DATA = {
  ...
  shoppingDefaults: [
    ...
    { item: 'Onions 1 kg', cat: 'Vegetables' },
    { item: 'Tomatoes 1 kg', cat: 'Vegetables' },
    { item: 'Potatoes 1 kg', cat: 'Vegetables' },
    { item: 'Ginger + garlic', cat: 'Vegetables' },
    { item: 'Green chillies + curry leaves', cat: 'Vegetables' },
    { item: 'Keerai / spinach greens 2 bunches', cat: 'Vegetables' },
    { item: 'Methi / coriander / mint', cat: 'Vegetables' },
    { item: 'Carrots 500g', cat: 'Vegetables' },
    { item: 'Beans 500g', cat: 'Vegetables' },
    { item: 'Cauliflower / gobi 1', cat: 'Vegetables' },
    { item: 'Cabbage 1', cat: 'Vegetables' },
    { item: 'Capsicum / bell peppers 3', cat: 'Vegetables' },
    { item: 'Brinjal / baingan 500g', cat: 'Vegetables' },
    { item: 'Bhindi / okra 500g', cat: 'Vegetables' },
    { item: 'Lauki / bottle gourd 1', cat: 'Vegetables' },
    { item: 'Ridge/snake gourd 1', cat: 'Vegetables' },
    { item: 'Ash gourd / pumpkin (kootu)', cat: 'Vegetables' },
    { item: 'Chow chow / drumstick', cat: 'Vegetables' },
    { item: 'Beetroot 250g', cat: 'Vegetables' },
    { item: 'Cucumber 3 (salad)', cat: 'Vegetables' },
    { item: 'Green peas 250g', cat: 'Vegetables' },
    { item: 'Mushrooms 200g', cat: 'Vegetables' },
    { item: 'Broccoli 1', cat: 'Vegetables' },
    { item: 'Raw banana (vazhakkai) 2', cat: 'Vegetables' },
    { item: 'Sweet potato / yam', cat: 'Vegetables' },
    { item: 'Lemons 6', cat: 'Vegetables' },
    { item: 'Coconut (avial/kuzhambu) 1', cat: 'Produce' },
    { item: 'Bananas 1 dozen', cat: 'Produce' },
    { item: 'Apples / seasonal fruit', cat: 'Produce' },
    { item: 'Papaya / guava', cat: 'Produce' },
